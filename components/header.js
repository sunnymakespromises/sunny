...
export default function Header({}) {
    const { currentPage, isHome, isLandscape } = useHomeContext()
    ...
    return (
        <div id = 'header' className = {'transition-all absolute md:relative top-0 w-full h-10 md:h-7 flex flex-row items-center px-4 md:px-4 pt-4 md:pt-0' + (isLandscape ? ' backdrop-blur-header backdrop-brightness-[0.90]' : ' backdrop-blur-0 backdrop-brightness-1') + ' z-10'}>
